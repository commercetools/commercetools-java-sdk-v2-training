...
public class PrefixHelper {
    ...
    public static String getDevApiClientPrefix() { return apiDevClientPrefix; }

    public static String getTestApiClientPrefix() { return apiTestClientPrefix; }

    public static String getDevImportClientPrefix() { return apiDevImportPrefix; }

    public static String getStoreApiClientPrefix() { return storeApiClientPrefix; }

    public static String getMeApiClientPrefix() { return meApiClientPrefix; }
}
